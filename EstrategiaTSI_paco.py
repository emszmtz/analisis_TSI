...
# Contrato (NQ futures - contrato continuo con rollover automático)
SYMBOL = 'NQ'
EXCHANGE = 'CME'
...
class TSITradingBot:
    ...
    def connect(self):
        ...
        # Definir contrato continuo (rollover automático)
    ...
    def load_historical_data(self):
        ...
        bars = self.ib.reqHistoricalData(
            self.contract,
            endDateTime='',
            durationStr=f'{bars_needed * TIMEFRAME_MINUTES * 2} S',
